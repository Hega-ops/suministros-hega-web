...
const PromoRollosBanner = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-slate-900 py-16">
      {/* Fondo con gradiente dinámico y patrón de puntos */}
      <div className="absolute inset-0 opacity-20" 
           style={{ backgroundImage: 'radial-gradient(#06b6d4 0.5px, transparent 0.5px)', backgroundSize: '24px 24px' }}>
      </div>
      <div className="absolute -top-24 -right-24 w-96 h-96 bg-cyan-600/20 rounded-full blur-[100px]"></div>
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-blue-600/20 rounded-full blur-[100px]"></div>

      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            
            {/* Contenedor de Imagen con Efecto de "Producto Premium" */}
            <div className="relative group w-full lg:w-1/3 flex justify-center">
              ...
              <div className="relative bg-gradient-to-b from-white to-slate-100 p-6 rounded-3xl shadow-2xl transform -rotate-2 group-hover:rotate-0 transition-transform duration-500">
                <img 
                ...
                />
                <div className="absolute top-4 right-4 bg-cyan-600 text-white text-[10px] font-black px-2 py-1 rounded-md uppercase tracking-tighter">
                  Stock Disponible
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-bold mb-6 tracking-widest uppercase">
                <Zap size={14} className="fill-cyan-400" /> Nuevo Lanzamiento
              </div>
              
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
                Rollos Térmicos que <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">no fallan en tu venta.</span>
              </h2>

              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                {[
                  { t: "Medidas estándar", d: "57mm y 80mm siempre en stock." },
                  { t: "Calidad Premium", d: "Impresión nítida y sin residuos." },
                  { t: "Precios de Mayoreo", d: "Ahorra más comprando por caja." },
                  { t: "Entrega Inmediata", d: "Surtido rápido en sucursales." }
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <CheckCircle size={18} className="text-cyan-500 shrink-0 mt-1" />
                    <div className="text-left">
                      <p className="text-white font-bold text-sm leading-none mb-1">{item.t}</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-cyan-600 hover:bg-cyan-500 text-white px-10 py-4 rounded-2xl font-black text-lg transition-all hover:scale-105 shadow-xl shadow-cyan-900/40 flex items-center justify-center gap-3"
                >
                  <MessageCircle size={24} />
