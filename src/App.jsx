      ...
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        ...
        <div className="mt-12 bg-slate-900 text-white p-8 rounded-2xl">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h3 className="text-xl font-bold text-yellow-400 flex items-center gap-2"><Save size={20}/> Guardar Cambios Manuales</h3>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 border-t border-slate-700 pt-8">
            <div className="flex-1 w-full">
              ...
              <p className="text-slate-400 text-sm mb-4">
                Descarga tu catálogo actual para editarlo en Excel/Editor.
              </p>
              <button 
              ...
              >
                <ArrowRight size={18} className="rotate-90" /> Descargar Catálogo
              </button>
            </div>
            ...
            <div className="flex-1 w-full border-t md:border-t-0 md:border-l border-slate-700 pt-6 md:pt-0 md:pl-8">
              ...
              <p className="text-slate-400 text-sm mb-4">
                Sube un archivo .json para reemplazar toda la base de datos al instante.
              </p>
...
const PromoRollosBanner = () => {
  const mensajeRollos = "Hola, me interesa cotizar la promoción de rollos para miniprinter.";
  
  return (
    <div className="relative overflow-hidden bg-slate-900 py-8"> {/* Reducido de py-16 a py-8 */}
      {/* Fondo con sutil patrón de puntos y luces */}
      <div className="absolute inset-0 opacity-10" 
           style={{ backgroundImage: 'radial-gradient(#06b6d4 0.5px, transparent 0.5px)', backgroundSize: '20px 20px' }}>
      </div>
      <div className="absolute -top-24 -right-24 w-64 h-64 bg-cyan-600/20 rounded-full blur-[80px]"></div>

      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-[2rem] p-6 md:p-8 shadow-2xl">
          <div className="flex flex-col md:flex-row items-center gap-8">
            
            {/* Contenedor de Imagen más compacto */}
            <div className="relative group w-full md:w-1/4 flex justify-center">
              <div className="absolute inset-0 bg-cyan-500 rounded-full blur-3xl opacity-10"></div>
              <div className="relative bg-white p-3 rounded-2xl shadow-xl transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                <img 
                  src="/rollos-promo.jpg" 
                  alt="Rollos Térmicos Hega" 
                  className="w-32 h-32 md:w-40 md:h-40 object-contain"
                  onError={(e) => { e.target.src = "https://images.unsplash.com/photo-1556742049-0cfed4f7a07d?auto=format&fit=crop&q=80&w=400"; }}
                />
              </div>
            </div>
            ...
            <div className="flex-1 text-center md:text-left">
              {/* Badge Estilo Solicitado */}
              <div className="inline-block bg-[#FACC15] text-slate-900 px-6 py-1.5 rounded-full font-black text-sm mb-4 shadow-[0_4px_20px_rgba(250,204,21,0.3)] uppercase tracking-wider">
                ¡PROMOCIÓN!
              </div>
              
              <h2 className="text-3xl md:text-4xl font-black text-white mb-3 leading-tight">
                Rollos para Miniprinter <span className="text-cyan-400">al mejor precio.</span>
              </h2>

              <p className="text-slate-400 text-sm md:text-base max-w-2xl mb-6">
                Térmicos y Bond en todas las medidas (57mm, 80mm). Calidad premium para una impresión nítida y duradera.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center md:items-start">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-cyan-600 hover:bg-cyan-500 text-white px-8 py-3 rounded-xl font-bold text-base transition-all hover:scale-105 shadow-lg shadow-cyan-900/40 flex items-center justify-center gap-2"
                >
                ...
                <div className="flex gap-4">
                  <div className="text-center">
                    <p className="text-white font-bold text-xs uppercase">57mm</p>
                    <p className="text-cyan-500 text-[10px] font-bold">DISPONIBLE</p>
                  </div>
                  <div className="w-px h-8 bg-slate-700"></div>
                  <div className="text-center">
                    <p className="text-white font-bold text-xs uppercase">80mm</p>
                    <p className="text-cyan-500 text-[10px] font-bold">DISPONIBLE</p>
                  </div>
                </div>
              </div>
